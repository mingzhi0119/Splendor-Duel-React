...
export const Rulebook = ({ onClose, theme }) => {
    ...
    return (
        <div className="fixed inset-0 z-[200] bg-black/80 flex items-center justify-center animate-in fade-in duration-200" onClick={onClose}>
            <div 
                ...
                {/* Header */}
                <div className={`flex items-center justify-between p-4 border-b transition-colors duration-500 ${theme === 'dark' ? 'border-slate-800 bg-slate-950/50' : 'border-slate-200 bg-slate-50/50'}`}>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button onClick={onClose} className={`${theme === 'dark' ? 'text-slate-400 hover:text-white' : 'text-slate-500 hover:text-slate-900'} transition-colors`}>
                            <X size={24} />
                        </button>
                    </div>
                </div>
                ...
                {/* Footer / Pagination */}
                <div className={`p-4 border-t flex items-center justify-between transition-colors duration-500 ${theme === 'dark' ? 'border-slate-800 bg-slate-950/50' : 'border-slate-200 bg-slate-50/50'}`}>
                    <button 
