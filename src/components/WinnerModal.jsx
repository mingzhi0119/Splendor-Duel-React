...
export const WinnerModal = ({ winner, onReview }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-black/90 flex flex-col items-center justify-center animate-in zoom-in duration-300">
           ...
           <div className="flex gap-4">
               <button onClick={onReview} className="flex items-center gap-2 bg-slate-700 hover:bg-slate-600 text-white px-6 py-3 rounded-full font-bold text-lg shadow-xl transition-transform hover:scale-105"><Eye size={20}/> Review Board</button>
